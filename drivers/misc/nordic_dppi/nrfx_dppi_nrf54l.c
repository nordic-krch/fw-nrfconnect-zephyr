...
/* All nodes in the system. */
static const struct nrf_dppi_node dppi_nodes[] = {
...
const struct nrf_dppi_route dppi_routes[] = {
	NRF_DPPI_ROUTE_DEFINE("mcu", DPPI_LUMOS_DOMAIN_MCU, (&dppi_nodes[NRF_DPPI_NODE_DPPIC00])),
	NRF_DPPI_ROUTE_DEFINE("rad", DPPI_LUMOS_DOMAIN_RAD, (&dppi_nodes[NRF_DPPI_NODE_DPPIC10])),
	NRF_DPPI_ROUTE_DEFINE("peri", DPPI_LUMOS_DOMAIN_PERI, (&dppi_nodes[NRF_DPPI_NODE_DPPIC20])),
	NRF_DPPI_ROUTE_DEFINE("lp", DPPI_LUMOS_DOMAIN_LP, (&dppi_nodes[NRF_DPPI_NODE_DPPIC30])),
	NRF_DPPI_ROUTE_DEFINE("rad_mcu", DPPI_LUMOS_DOMAIN_RAD,
			(&dppi_nodes[NRF_DPPI_NODE_DPPIC10],
			 &dppi_nodes[NRF_DPPI_NODE_PPIB10_00],
			 &dppi_nodes[NRF_DPPI_NODE_DPPIC00])),
	NRF_DPPI_ROUTE_DEFINE("rad_peri", DPPI_LUMOS_DOMAIN_RAD,
			(&dppi_nodes[NRF_DPPI_NODE_DPPIC10],
			 &dppi_nodes[NRF_DPPI_NODE_PPIB11_21],
			 &dppi_nodes[NRF_DPPI_NODE_DPPIC20])),
	NRF_DPPI_ROUTE_DEFINE("rad_lp", DPPI_LUMOS_DOMAIN_RAD,
			(&dppi_nodes[NRF_DPPI_NODE_DPPIC10],
			 &dppi_nodes[NRF_DPPI_NODE_PPIB11_21],
			 &dppi_nodes[NRF_DPPI_NODE_DPPIC20],
			 &dppi_nodes[NRF_DPPI_NODE_PPIB22_30],
			 &dppi_nodes[NRF_DPPI_NODE_DPPIC30])),
	NRF_DPPI_ROUTE_DEFINE("mcu_peri", DPPI_LUMOS_DOMAIN_MCU,
			(&dppi_nodes[NRF_DPPI_NODE_DPPIC00],
			 &dppi_nodes[NRF_DPPI_NODE_PPIB01_20],
			 &dppi_nodes[NRF_DPPI_NODE_DPPIC20])),
