...
const struct nrf_dppi_route dppi_routes[] = {
	NRF_DPPI_ROUTE_DEFINE("apb2", NRF_DPPI_DOMAIN_APB2, (&dppi_nodes[NRF_DPPI_NODE_DPPIC020])),
	NRF_DPPI_ROUTE_DEFINE("apb3", NRF_DPPI_DOMAIN_APB3, (&dppi_nodes[NRF_DPPI_NODE_DPPIC030])),
	NRF_DPPI_ROUTE_DEFINE("apb2_apb3", NRF_DPPI_DOMAIN_APB2,
			(&dppi_nodes[NRF_DPPI_NODE_DPPIC020],
			 &dppi_nodes[NRF_DPPI_NODE_PPIB020_030],
			 &dppi_nodes[NRF_DPPI_NODE_DPPIC030])),
};
